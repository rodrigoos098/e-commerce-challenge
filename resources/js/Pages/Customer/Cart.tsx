        ...
        return (
            <PublicLayout title="Carrinho">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-20 text-center">
                    <div className="flex h-24 w-24 items-center justify-center rounded-full bg-kintsugi-50 mx-auto mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-kintsugi-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2} aria-hidden="true">
                    ...
                    <h1 className="font-display text-2xl font-extrabold text-warm-700 mb-2">Sua sacola está vazia</h1>
                    <p className="text-warm-500 mb-8 max-w-xs mx-auto leading-relaxed">Cada peça tem uma história. Encontre a que vai contar a sua.</p>
                    <Link
                        href="/products"
                        className="inline-flex items-center gap-2 rounded-full bg-kintsugi-500 px-8 py-3 text-sm font-bold text-white hover:bg-kintsugi-600 transition-colors shadow-lg"
                    >
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
                <div className="mb-6 flex flex-wrap items-center justify-between gap-2">
                    ...
                    <button
                        ...
                        className="text-sm text-red-500 hover:text-red-700 transition-colors font-medium shrink-0"
                    >
                        Limpar carrinho
                    </button>
                </div>
