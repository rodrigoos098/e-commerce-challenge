...
const CATEGORY_ICONS: Record<string, React.ReactNode> = {
    ceramicas: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3C8 3 5 6 5 10c0 2.5 1 4.5 2.5 6H5l1 3h12l1-3h-2.5C18 14.5 19 12.5 19 10c0-4-3-7-7-7z" /></svg>
    ),
    texteis: (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                        {categories.map((cat) => (
                            ...
                            >
                                ...
                                <span className="text-xs font-semibold text-warm-600 group-hover:text-kintsugi-600 transition-colors">
                                    {cat.name}
                                </span>
                            </Link>
                        ))}
