  ...
  return (
    <section className="relative overflow-hidden bg-cream py-16 sm:py-20 lg:py-24">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        <svg
          className="absolute top-1/3 left-0 w-full h-24 opacity-20"
          viewBox="0 0 1200 80"
          preserveAspectRatio="none"
        >
          <path
            d="M0,40 C150,10 300,70 450,35 C600,0 750,60 900,30 C1050,0 1150,50 1200,40"
            stroke="currentColor"
            strokeWidth="1.5"
            fill="none"
            className="text-kintsugi-400"
          />
        </svg>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1
            className="mt-2 font-display text-4xl font-extrabold tracking-tight text-warm-900 sm:text-5xl lg:text-7xl animate-fade-up"
          ...
          <p
            className="mt-8 text-xl text-warm-600 leading-relaxed animate-fade-up max-w-xl"
          ...
          <div
            className="mt-12 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 animate-fade-up"
          ...
          {stats && stats.product_count > 0 && (
            <div
              className="mt-20 border-l-2 border-kintsugi-200/70 pl-6 animate-fade-up"
              style={{ animationDelay: '500ms' }}
            >
              <p className="text-sm font-medium text-warm-600 sm:text-base max-w-sm leading-relaxed">
                Abrigando atualmente{' '}
                <span className="font-bold text-warm-900">
                  {stats.product_count} obras de autor
                </span>
                , cultivadas através de{' '}
                <span className="font-bold text-warm-900">
                  {stats.category_count} saberes artesanais
                </span>
                .
              </p>
            </div>
      ...
      {products && products.length > 0 && (
        ...
        >
          <KintsugiConstellation products={products.slice(0, 6)} />
        </div>
      )}
    </section>
  );
