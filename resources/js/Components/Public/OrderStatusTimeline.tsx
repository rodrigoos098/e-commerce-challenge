...
const STEPS: Step[] = [
  { key: 'pending', label: 'Confirmado', description: 'Estoque reservado' },
          ...
          return (
            <li key={step.key} className="flex flex-1 items-start sm:flex-col">
              ...
              <div className="ml-3 sm:ml-0 sm:mt-2 sm:text-center">
                <p
                  className={`text-xs font-semibold ${isCurrent ? 'text-kintsugi-600' : isDone ? 'text-warm-600' : 'text-warm-400'}`}
                >
                  {step.label}
                </p>
