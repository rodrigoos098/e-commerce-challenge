    ...
    <footer className="bg-warm-800 text-warm-300">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div className="sm:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <img src="/logo-white.svg" alt="Shopsugi Logo" className="h-12 w-auto" />
            </Link>
            <p className="font-display text-base italic text-warm-300 leading-relaxed mb-3">
              Arte feita à mão, entregue com carinho.
            </p>
            <p className="text-xs text-warm-500">
              Inspirado pelo <span className="text-kintsugi-400/80 font-medium">Kintsugi</span> — a
              arte de reparar com ouro, celebrando a beleza nas imperfeições.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-warm-400 hover:text-kintsugi-400 transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-10 border-t border-warm-700 pt-6 text-center">
          ...
          <p className="text-xs text-warm-500">
            © {new Date().getFullYear()} Shopsugi. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
