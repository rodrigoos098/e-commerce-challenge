    ...
    const photos = useMemo(
        () =>
            products.slice(0, LAYOUT.length).map((p, i) => ({
                id: p.id,
                src: p.image_url ?? `/storage/products/${p.id}.webp`,
                alt: p.name,
                ...LAYOUT[i],
            })),
        [products],
                ...
                >
                    ...
                    >
                        ...
                        >
                            {/* Photo card */}
                            <div
                                className="h-full w-full overflow-hidden rounded-2xl border border-warm-200/50 bg-white shadow-lg shadow-warm-900/5 animate-fade-up"
